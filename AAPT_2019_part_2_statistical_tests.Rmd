...
Using the code from Part 1 as a reference, fill out the following blank chunk to generate box plots, histograms and scatter plots for the data using GGPLOT.  Code to generate these plots using base R is provided below the blank spaces.
...
1. What do the results of the $t$-test say about the pre and post scores?
2. What do the results of the effect size say about the pre and post scores?
3. Is there a meaningful difference between the pre and post scores?
